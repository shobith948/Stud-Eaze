...
public class AdminActivity extends AppCompatActivity { //class for admin dashboard activity
    ...
    public  void remStudent(){
        ...
        btn_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(AdminActivity.this, "Please Enter Usn....", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if(dataSnapshot.child("students").child(usn).exists()){
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if(task.isSuccessful()){
                                                    Toast.makeText(AdminActivity.this, "Student with USN "+usn+" is removed Successfully", Toast.LENGTH_SHORT).show();
                                                }
                                                else {
                                ...
                                Toast.makeText(AdminActivity.this, "Provided USN "+usn+" is not registered", Toast.LENGTH_SHORT).show();
                                Toast.makeText(AdminActivity.this, "Retry removal", Toast.LENGTH_SHORT).show();
                            }
                        }
    ...
    public  void remTeacher(){
        final AlertDialog.Builder alert = new AlertDialog.Builder(AdminActivity.this); //alert dialog builder
        ...
        btn_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(AdminActivity.this, "Please Enter Subject Code....", Toast.LENGTH_SHORT).show();
                }
                else {
                    final DatabaseReference RootRef;
                    RootRef= FirebaseDatabase.getInstance().getReference();
                    ...
                    RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if(dataSnapshot.child("teachers").child(sub_code).exists()){
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if(task.isSuccessful()){ //checks if deletion is successful or not
                                                    ...
                                                    Toast.makeText(AdminActivity.this, "Teacher with Subject Code "+sub_code+" is removed Successfully", Toast.LENGTH_SHORT).show();
                                                }
                                                else {
                                                    Toast.makeText(AdminActivity.this, "Network Error", Toast.LENGTH_SHORT).show();
                                                    Toast.makeText(AdminActivity.this,"Try again", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(AdminActivity.this, "Provided Subject Code "+sub_code+" is not registered", Toast.LENGTH_SHORT).show();
                                Toast.makeText(AdminActivity.this, "Retry removal", Toast.LENGTH_SHORT).show();
                            }
                        }
