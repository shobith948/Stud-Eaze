...
public class HomeActivity extends AppCompatActivity {  //class for the home screen
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child("students").child(usn).exists()) {
                    UsersModel studentsData = dataSnapshot.child("students").child(usn).getValue(UsersModel.class);
                    ...
                    if (studentsData.getUsn().equals(usn)) {
                        ...
                        Toast.makeText(HomeActivity.this, "Retry Login", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(HomeActivity.this, "Account with " + usn + " does not exist", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child("teachers").child(s_code).exists()) {
                    UsersModel teachersData = dataSnapshot.child("teachers").child(s_code).getValue(UsersModel.class);
                    ...
                    Toast.makeText(HomeActivity.this, "Account with " + s_code + " does not exist", Toast.LENGTH_SHORT).show();
                }
