...
public class StudentDashboardActivity extends AppCompatActivity implements View.OnClickListener{ //class for student dashboard
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.view_attendance:
                i = new Intent(this, AttendanceAdapter.class);
                startActivity(i);
                break;

            case R.id.S_marks:
                i = new Intent(this, MarksAdapter.class);
                startActivity(i);
                break;
