...
public class StudentLoginActivity extends AppCompatActivity { //class for student login
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LoadingDialogAcitivity loading_dialog = new LoadingDialogAcitivity(StudentLoginActivity.this);
        ...
        login_btn.setOnClickListener(v -> {
            if(S_usn.getText().toString().equals("admin") && S_password.getText().toString().equals("admin123")){
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(StudentLoginActivity.this, "You are now an Admin", Toast.LENGTH_SHORT).show();
                        loading_dialog.dismissDialog();
                        Intent intent = new Intent(StudentLoginActivity.this, AdminActivity.class);
    ...
    private void LoginStudent()
    {
        ...
        {
            Toast.makeText(StudentLoginActivity.this, "Please Enter your usn number....", Toast.LENGTH_SHORT).show();
        }
        else
        ...
        {
            Toast.makeText(StudentLoginActivity.this, "Invalid USN", Toast.LENGTH_SHORT).show();
        }
        else
        {
    ...
    private void AllowAccess(final String usn, final String password)
    {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                {
                    UsersModel userData = dataSnapshot.child("students").child(usn).getValue(UsersModel.class); //Gets a DatabaseReference for the database specified child node.
                    ...
                    {
                        Toast.makeText(StudentLoginActivity.this, "Error in get method", Toast.LENGTH_SHORT).show();
                    }

                }
                else
                {
                    Toast.makeText(StudentLoginActivity.this, "Account with " + usn + " does not exist", Toast.LENGTH_SHORT).show();
                }
            }
