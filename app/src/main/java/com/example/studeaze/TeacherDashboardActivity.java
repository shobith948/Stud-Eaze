...
public class TeacherDashboardActivity extends AppCompatActivity implements View.OnClickListener{ //class for teacher dashboard
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(TeacherDashboardActivity.this, HomeActivity.class);
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child("teachers").child(s_code).exists()) {
                    UsersModel teachersData = dataSnapshot.child("teachers").child(s_code).getValue(UsersModel.class); //Gets a DatabaseReference for the database specified child node
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.T_marks:
                i = new Intent(this, AddMarksActivity.class); //Redirect to the specifies class
                startActivity(i);
                break;

            case R.id.T_notice:
                i = new Intent(this, NoticeAdapter.class);
                startActivity(i);
                break;
