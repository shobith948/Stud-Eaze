...
public class TimeTableActivity extends AppCompatActivity { //class for time table display
        ...
        rootref2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                rootref.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ImageTable tab =  snapshot.child(String.valueOf(sem)).getValue(ImageTable.class);
