...
public class add_marks extends AppCompatActivity { //class for the teacher to add marks and attendance
    ...
    private void UpdateMarks(final String attendance, final String usn, final String c1, final String c2, final String c3, final String avg) {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                students studentData = dataSnapshot.child("students").child(usn).getValue(students.class);
                students teacherData = dataSnapshot.child("teachers").child(SubCode).getValue(students.class);
                ...
                if(dataSnapshot.child("students").child(usn).exists() && Objects.equals(studentData.getSemester(), teacherData.getSemester())) {
                    ...
                    Toast.makeText(add_marks.this, "Enter valid USN", Toast.LENGTH_SHORT).show();
                }
            }
