...
public class add_notice extends AppCompatActivity { //class for the admin to add notice
                        ...
                        else if(TextUtils.isEmpty(notice_d))
                        {
                            ...
                            handler.postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    Toast.makeText(add_notice.this, "Notice added successfully", Toast.LENGTH_SHORT).show();
